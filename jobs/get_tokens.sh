...
args=(--model_name custom-bert # custom-bert, albert
      ...
      --token_file_path "/home/anonuser/thesis/data/top_tokens/GAE_random_tokens_sst_bert.json" # sst imdb
      --output_file_path "/home/anonuser/thesis/data/tokens_position_masks/GAE_random_tokens_sst_bert.json"
...
#       --project_dir "/home/anonuser/thesis/"
